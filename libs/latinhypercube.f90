module latinhypercube

  ! Originally a set of functions saved in the file latin_random.f90,
  ! obtained from: John Burkardt,
  ! http://people.sc.fsu.edu/~jburkardt/f_src/latin_random/latin_random.html
